...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">HARIShukla.org</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="jobApplication1.jsp">Apply</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To harishukla.org</h1>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Welcome to Job Application, your go-to platform for discovering the ideal job opportunities. We are committed to bridging the gap between job seekers and employers, streamlining the job search process for utmost convenience.
				...
				<div class="col-lg-4 me-auto">
					<p class="lead">We understand the importance of presenting a compelling resume to stand out from the competition. That's why we offer a resume builder tool to help you create a professional resume that highlights your qualifications and experiences.

					Preparing for interviews is crucial,
			...
			<div class="text-center mt-4">
				...
				<a class="btn btn-xl btn-outline-light"
					href="#"> <i
					class="fab fa-linkedin-in"></i> Facebook
				</a>
				<a class="btn btn-xl btn-outline-light"
					href="#"> 
    ...
    <div class="form-floating mb-3">
        <input class="form-control" name="fname" id="name" type="text" placeholder="Enter your name..." required />
	...
	<footer class="footer text-center">
		<div class="container">
			<div class="row">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">Create Your Website</h4>
					<p class="lead mb-0">
						We work to create a website as a freelancer as well. <a href="#contact">Contact US</a> .
					</p>
				</div>
			</div>
		</div>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; harishukla.org 2021</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Image-->
								<img class="img-fluid rounded mb-5"
									src="assets/img/portfolio/safe.png" alt="..." href="https://www.digitalocean.com/community/tutorials/java-collections-interview-questions-and-answers" />
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">This is a project of final year</p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
